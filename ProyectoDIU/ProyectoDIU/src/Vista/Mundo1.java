...
public class Mundo1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Mapa1.add(Avatar, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 510, 40, 40));
        ...
        Mapa2.add(enemigo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 70, 40, 40));

        enemigo2.setBackground(new java.awt.Color(255, 0, 0));
        enemigo2.setOpaque(true);
        Mapa2.add(enemigo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 130, 40, 40));
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup()
                    .addComponent(Mapa2, javax.swing.GroupLayout.PREFERRED_SIZE, 600, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGap(0, 0, Short.MAX_VALUE)))
        );
    ...
    public class mapa1{
        ...
        public boolean limites(int x, int y, String direccion){
            ...
            if(direccion.equals("up")){
                if ((x <= 40 && y == 500)
                || ((x >= 70 && x <= 840) || (x >= 870)) && y == 500
                || ((x <= 140 || (x > 150 && x <= 230)) || (x >= 260 && x <= 380)||(x>=520 && x<=640)||(x>=670 && x<=740)||x>=770) && y == 400
                || ((x >= 70 && x <= 390)|| (x>=520 && x<=840)) && y == 300
                || ((x >= 50 && x <= 190) || (x >= 220 && x <= 290) || (x >= 320 && x <= 390)||(x>=500 && x<=640)||(x>=670 && x<=740)||(x>=770 && x<=840)) && y == 200
                || ((x >= 200 && x <= 210) || (x >= 400 && x <= 410)||(x>=650 && x<=660)||(x>=850 && x<=860)) && y == 150
                || (x >= 50 && x <= 860) && y == 50) 
                {
                    return limite = false;
                }
            ...
            if(direccion.equals("down")){
                if(y==510
                || (x>=70 && x<=840) && y==410
                || ((x>=50 && x<=140)||(x>=160 && x<=230)||(x>=260 && x<=380)||(x>=520 && x<=640)||(x>=670 && x<=740)||x>=770) && y==310
                || ((x>=70 && x<=390) || (x>=520 && x<=840) ) && y==210
                || ((x>=50 && x<=110) || (x>=500 && x<=560)|| x>=770 ) && y==110
                || ((x>=120 && x<=290) || (x>=320 && x<=490)|| (x>=570 && x<750)||x>=810 ) && y==60)
                {
                    return limite = false;
                }
            ...
            if(direccion.equals("right")){
                if((y>=420 && y<=490) &&  x==60
                ||( y>=150 && x==410)
                ||(((y>=320 && y<= 390) && (x==150 || x==250 || x==510 || x==660 ||x==760)))
                ||(y>=220 &&  y<= 290) && (x==60 || x==510)
                ||(y>=70 &&  y<= 190) && (x==310 || x==660)
                ||((y>140 && y<=190) && x==210)
                ||((y>=120 && y<=190) && x==760)
                ||((y>=70 && y<=110) && (x==110 || x==560 || x==810))
                ||((y>=50 && y<=490) && x==860)
                        )
                {
                    return limite = false;
...
//                
            ...
            if(direccion.equals("left")){
                ...
                ||(y>=420 && y<=490) &&  x==850
                ||( y>=150 && x==500)
                ||(((y>=320 && y<= 390) && (x==150 || x==240 || x==390 || x==650 ||x==750)))
                ||(y>=220 &&  y<= 290) && (x==400 || x==850)
                ||(y>=70 &&  y<= 190) && (x==300 || x==750)
                ||((y>140 && y<=190) && (x==200 || x==400 || x==650))
                ||((y>=120 && y<=190) && x==850)
                ||((y>=70 && y<=190) && (x==500 || x==750))
                        )     
                {
                    return limite = false;
                }
    ...
    public class mapa2{
        ...
        public boolean limites(int x, int y, String direccion){
            boolean limite=true;
            if(direccion.equals("up")){
                if(((x<=40 || (x>=70 && x<=140)||(x>=170 && x<=240)||(x>=500 && x<=640)||(x>=670 && x<=740)|| x>=770) && y==500)
                ||((x<=140 || (x>=250 && x<=310)||(x>=520 && x<=840))&& y==400)
                ||(((x>=70 && x<=240)||(x>=320 && x<=590)||(x>=670 && x<=740)||x>=770)&& y==300)
                ||((x>=70 && x<=140)||(x>=270 && x<=340)||(x>=570 && x<=840))&&y==200
                ||((x>=350 && x<=560)&& y==150)
                ||(x>=50 && y==50)
                    )
                    {
            ...
            if(direccion.equals("down")){
                if(((x>=-40 && x<=590)||x>=620) && y==510
                || ((x>=70 && x<=140)||(x>=500 && x<=640)||(x>=670 && x<=740)|| x>=770) && y==410
                || ((x>=50 && x<=140)||(x>=170 && x<=390)||(x>=520 && x<=840)) && y==310
                || ((x>=70 && x<=170)||(x>=320 && x<=590) || x>=770) && y==210
                || ((x>=650 && x<=660)||(x>=750 && x<=760)) && y==110
                || ((x>=70 && x<=140)||(x>160 && x<=240) ||(x>=270 && x<=640)||(x>=670 && x<=740)||(x>=770 && x<=840)) && y==60
                    )
                    {
                        return limite = false;
                    }
            ...
            if(direccion.equals("right")){//(y>=420 && y<=490)||(y>=70 && y<=190)||(y>=210 &&y<=280)||
                ...
                ||((y>=320 && y<=490 ||(y>=70 && y<=220))) && x==160
                ||((y>=220 && y<=290)|| y>=400) && x==310
                ||(y>=70 && y<=190) && x==260
                ||y>=150 && x==410
                ||(y>=320 && y<=390) && x==510
                ||(y>=150 && y<=190) && x==560
                ||y>=520 && x==610
                ||((y>= 70&& y<=110)||(y>=420 && y<=490)||(y>=200 && y<=290))&& x==660
                ||((y>= 70&& y<=110)||(y>=220 && y<=290)||(y>=420 && y<=490))&& x==760
                ||y>=0 && x==860
            ...
            if(direccion.equals("left")){
                if((y>=0 && y<=490) && x<=50
                ||y>=0 && x==0
                || ((y>=420 && y<=490) || (y>=320 && y<=390)||(y>=70 && y<=190)) && x==150
                || ((y>=400 && y<=490)||(y>=70 && y<=290))&& x==250
                || ((y>=150 && y<=190 ) && x==350)
                || ((y>=320 && y<=500 ) && x==400)
                || (y>=140 && x==500)
                || ((y>=220 && y<=290)|| y>=520) && x==600
                || ((y>=70 && y<=120)||(y>=420 && y<= 490)) && x==650
                || ((y>=70 && y<=120)||(y>=200 && y<=290)||(y>=420 && y<=490)) && x==750
                || ((y>=70 && y<=190)||(y>=320 && y<=390)) && x==850
                )
